...
export default {
  ...
  methods: {
    ...
    getNewPosts(){
      axios.get(this.$store.getters.randomServer + '/categories/' + this.category + '/' + this.newPage + '/' + this.limit).then(res => {
        console.log(res);
        this.posts.new = res.data;
      }).catch(error => {console.log(error);});
    },
    getPopularPosts(){
      axios.get(this.$store.getters.randomServer + '/data/popular/category/'+ this.category + '/' + this.popularPage + '/' + this.limit).then(res => {
        console.log(res);
        this.posts.popular = res.data;
      }).catch(error => {console.log(error);});
    },
    getUpdatedPosts(){
      axios.get(this.$store.getters.randomServer + '/data/updated/category/'+ this.category + '/' + this.updatedPage + '/' + this.limit).then(res => {
        console.log(res);
